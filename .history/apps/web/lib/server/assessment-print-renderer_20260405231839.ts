...
export const ASSESSMENT_PRINT_LAYOUT_VERSION = "2026-04-06-compact-pdf-v19";
...
function renderAssessmentFileFooter(input: {
  ...
  return `
    <footer class="${input.variant}-footer assessment-file-footer">
...
export function buildAssessmentPrintHtml(input: {
  ...
  /* Keep card growth intentionally subtle: these values fill whitespace more gracefully across the
     shared file surface while preserving readability and the existing 2-then-3 page rhythm. */
  const firstPageQuestionCardMinHeight = "38mm";
  const followingPageQuestionCardMinHeight = "25mm";
  const followingPageQuestionCardPrintMinHeight = "27mm";
