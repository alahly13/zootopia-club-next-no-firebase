...
/* Card geometry was tuned slightly larger to reduce visual whitespace. Keep this budget a touch
  tighter so first-page overflow fallback still triggers early enough for dense stems/options. */
const ASSESSMENT_FILE_FIRST_PAGE_COMPLEXITY_BUDGET = 3320;
...
const ASSESSMENT_FILE_PAGE_COMPLEXITY_BUDGET = 3980;
